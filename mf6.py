...
def total_bills():
    ...
    if coffee_var.get() == 0:
        ...
        message.showerror("error","please fill the coffee quantity")
        coffee_q = 0
    ...
    if tea_var.get() == 0:
        ...
        message.showerror("error","please fill the tea quantity")
        tea_q = 0
    ...
    if juice_var.get() == 0:
        ...
        message.showerror("error","please fill the juice quantity")
        juice_q = 0
    ...
    if shakes_var.get() == 0:
        ...
        message.showerror("error","please fill the shakes quantity")
        shakes_q = 0
    ...
    if milk_var.get() == 0:
        ...
        message.showerror("error","please fill the milk quantity")
        milk_q = 0
    ...
    if shikanji_var.get() == 0:
        ...
        message.showerror( "error","please fill the shikanji quantity")
        shikanji_q = 0
    ...
    if redbull_var.get() == 0:
        ...
        message.showerror("error","please fill the redbull quantity")
        redbull_q = 0
    ...
    if roti_var.get() == 0:
        ...
        message.showerror("error","please fill the roti quantity")
        roti_q = 0
    ...
    if dal_makhni_var.get() == 0:
        ...
        message.showerror("error","please fill the dal_makhni quantity")
        dal_makhni_q = 0
    ...
    if mutter_panner_var.get() == 0:
        ...
        message.showerror("error","please fill the muttter_panner quantity")
        mutter_panner_q = 0
    ...
    if paratha_var.get() == 0:
        ...
        message.showerror("error","please fill the paratha quantity")
        paratha_q = 0
    ...
    if mix_veg_var.get() == 0:
        ...
        message.showerror("error","please fill the mix_veg quantity")
        mix_veg_q = 0
    ...
    if omelete_var.get() == 0:
        ...
        message.showerror("error","please fill the omlete quantity")
        omelette_q = 0
    ...
    if veg_biriyani_var.get() == 0:
        ...
        message.showerror("error","please fill the veg_biriyani quantity")
        veg_biriyani_q = 0
    ...
    if rice_var.get() == 0:
        ...
        message.showerror("error","please fill the lassi quantity")
        rice_q = 0
...
def send():
    ...
    def send_bill():
        ...
        if ph_number == "":
            ...
            api = "ODC0h4etnqlUrg5iYyZNwcJQBbAxRL9ka3VzoHEGXMFpdvsPf8wLIJa2rPlxihzgm84Kn6vUN0uHpdBE"
...
foods = LabelFrame(innerframe2,width=275,height=205,relief=RIDGE,borderwidth=3,font=("verdana",10,"bold"),bg="#248aa2",highlightbackground="white",highlightcolor="white",highlightthickness="2")
foods.place(x=2,y=2)
...
nine = Button(innerframe4,text="9",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=nine)
nine.place(x=0,y=24)

eight = Button(innerframe4,text="8",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=eight)
eight.place(x=48,y=24)

seven = Button(innerframe4,text="7",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=seven)
seven.place(x=96,y=24)

plus = Button(innerframe4,text="+",padx=8,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=plus)
plus.place(x=144,y=24)


six = Button(innerframe4,text="6",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=six)
six.place(x=0,y=50)

five = Button(innerframe4,text="5",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=five)
five.place(x=48,y=50)

four = Button(innerframe4,text="4",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=four)
four.place(x=96,y=50)

minus = Button(innerframe4,text="-",padx=6,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=minus)
minus.place(x=144,y=50)


three = Button(innerframe4,text="3",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=three)
three.place(x=0,y=76)

two = Button(innerframe4,text="2",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=two)
two.place(x=48,y=76)

one = Button(innerframe4,text="1",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=one)
one.place(x=96,y=76)

multiply = Button(innerframe4,text="*",padx=7,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=mul)
multiply.place(x=144,y=76)


zero = Button(innerframe4,text="0",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=zero)
zero.place(x=0,y=102)

clear = Button(innerframe4,text="C",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=clear)
clear.place(x=48,y=102)

equal = Button(innerframe4,text="=",padx=15,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=equal)
equal.place(x=96,y=102)

divide = Button(innerframe4,text="/",padx=7,relief=RAISED,borderwidth=2,font=("verdana",8,"bold"),bg="#248aa2",fg="white",command=divide)
